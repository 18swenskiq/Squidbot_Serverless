...
export abstract class HandleComponentInteraction {
    ...
    private static async JoinPUG(
        ...
        // Add player to queue
        activeQueue.userIdsInQueue.push(interaction.member.user.id);
        await Services.CS2PugQueueSvc.Save(activeQueue);

        const currentPlayerCount = activeQueue.userIdsInQueue.length;
        ...
        // All pick map
            ...
            activeQueue.voteComponent = {
                id: voteDropdownInteractionGuid,
                type: HandlableComponentInteractionType.PUGMAPVOTE,
