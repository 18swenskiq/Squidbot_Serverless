...
import { AddScheduledPlaytestDeletedDateColumn1724283568610 } from '../migrations/1724283568610-add_scheduled_playtest_deleted_date_column';
...
export const AppDataSource = new DataSource({
    ...
    migrations: [
        ...
        AddScheduledPlaytestDeletedDateColumn1724283568610,
    ],
    ssl: true,
    extra: {
        ssl: {
